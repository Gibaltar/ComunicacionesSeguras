...
$listar = null;
$directorio = opendir("archivos3/");
while($elemento = readdir($directorio)){
	if(is_dir("archivos3/".$elemento)){
		$listar .= "<li><a href='archivos3/$elemento' target='_blank'>$elemento/</a></li>";
	}else{
		$listar .= "<li><a href='archivos3/$elemento' target='_blank'>$elemento</a></li>";
	}
}
...
<body style="background: #babdbf; min-height: 100vh;">
	...
	<h2 style="text-align: center;">ARCHIVOS GUARDADOS POR ADMINSTRADORES DE 3°</h2>
	<br>
	<br>
