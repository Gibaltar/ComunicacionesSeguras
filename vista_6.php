...
$listar = null;
$directorio = opendir("archivos6/");
while($elemento = readdir($directorio)){
	if(is_dir("archivos6/".$elemento)){
		$listar .= "<li><a href='archivos6/$elemento' target='_blank'>$elemento/</a></li>";
	}else{
		$listar .= "<li><a href='archivos6/$elemento' target='_blank'>$elemento</a></li>";
	}
}
...
<body style="background: #babdbf; min-height: 100vh;">
	...
	<h2 style="text-align: center;">ARCHIVOS GUARDADOS POR ADMINSTRADORES DE 6°</h2>
	<br>
	<br>
